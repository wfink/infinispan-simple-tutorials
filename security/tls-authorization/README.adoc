...
. Generate the example self-signed keystore and trust store.
+
----
$ sh create_unsigned_certificates.sh
----
+
If you prefer, run the Java keytool commands directly.
+
...
. Generate the example CA-signed keystore and trust store.
+
----
$ sh create_signed_certificates.sh
----
+
If you prefer, run the Java keytool commands directly.
+
...
. Run `$ create_signed_server_truststore_auth.sh` and generate the client trust store.
