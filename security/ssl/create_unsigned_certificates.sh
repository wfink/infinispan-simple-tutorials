# Create a basic keystore with PKCS12 use as rhdg-server alias and 'secret' as password
...
# Import the certificate for a client truststore with a different password 'trustSecret'
...
# Import the signed certificate to a truststore
